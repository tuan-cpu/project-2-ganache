...
export const TransactionProvider = ({ children }) => {
    ...
    const [user,setUser] = useState({displayName:'',id:'',donation_detail:[],email:'',provider:'',role:''});
    ...
    return (
        <TransactionContext.Provider value={{ connectWallet, currentAccount, formData, sendTransaction, handleChange, transactions, isLoading, signInFormData, signUpFormData, handleSignUp, handleSignIn, setFormData, user, setUser }}>
            {children}
