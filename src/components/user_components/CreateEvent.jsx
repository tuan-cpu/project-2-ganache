...
const CreateEvent = () => {
    ...
    useEffect(() => {
        ...
        if (user.verified) setUserVerified(true);
    }, []);
    ...
    return (
        <div className="gradient-bg-transactions min-h-screen">
            {userVerified ?
                <div className=" grid md:grid-cols-2 grid-cols-1 p-5 gap-[10px]">
                ...
                <div className="flex justify-center items-center flex-col">
                    <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
                        Hãy xác thực tài khoản của bạn trước!
                    </h1>
                    <NavLink className="my-[10px] text-[#3f51db] text-3xl sm:text-5xl" to='/verifyUser'>Ấn vào đây!</NavLink>
                </div>}
        </div>
    )
}
