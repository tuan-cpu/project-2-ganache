            ...
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                    ...
                    <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
                        <Input placeholder='Địa chỉ nhận' name='addressTo' type='text' handleChange={handleChange} />
                        <Input placeholder='Số lượng(ETH)' name='amount' type='number' handleChange={handleChange} />
                        <Input placeholder='Từ khóa' name='keyword' type='text' handleChange={handleChange} />
                        <Input placeholder='Thông điệp' name='message' type='text' handleChange={handleChange} />
